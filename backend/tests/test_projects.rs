...
mod project_tests {
    ...
    async fn test_get_projects() {
        ...
        let test_project = create_test_project(&client, "Project for Get Test").await
    ...
    async fn test_get_project_by_id() {
        ...
        // Create a test project
        let test_project = create_test_project(&client, "Project for GetById Test").await
            .expect("Failed to create test project");
        
        let project_id = test_project["id"].as_i64().expect("Failed to get project ID");
    ...
    async fn test_update_project() {
        ...
        // Create a test project
        let test_project = create_test_project(&client, "Project for Update Test").await
            .expect("Failed to create test project");
        ...
        assert_eq!(updated_project["description"], "Updated project description");
    }
    ...
    async fn test_delete_project() {
        ...
        // Create a test project
        let test_project = create_test_project(&client, "Project for Delete Test").await
            .expect("Failed to create test project");
